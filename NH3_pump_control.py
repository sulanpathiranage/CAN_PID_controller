...
class NH3PumpControlScene(QWidget):
    ...
    def __init__(self, data_manager: SystemDataManager):
        ...
        sensor_defs = [
            ...
            ("PI10134", "pressure", 3, (400, -440), "bar", True),
            ("PIC10126", "pressure", 4, (600, -440), "bar", True),
        ...
        SchematicHelperFunctions.CreateInputOutputLabel(self.systemControlScene, 50, 155, 25, "HV115\nL119-PID-101", -600, -475)
        SchematicHelperFunctions.CreateInputOutputLabel(self.systemControlScene, 26, 125, 13, "CHEM VENT", 905, -250)
        SchematicHelperFunctions.CreateInputOutputLabel(self.systemControlScene, 26, 125, 13, "CHEM VENT", 905, 40)
        SchematicHelperFunctions.CreateInputOutputLabel(self.systemControlScene, 26, 125, 13, "CHEM VENT", 905, 315)
        ...
        SchematicHelperFunctions.CreateTaggedCircleBox(self.systemControlScene, 25, "PI", "10134", 400, -350)
        SchematicHelperFunctions.CreateTaggedCircleBox(self.systemControlScene, 25, "PIC", "10126", 600, -350)
        ...
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, 900, -260, 900, 30, 2)    # UPPER CHEM VENT to LOWER CHEM VENT
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, 100, 30, 910, 30, 2)      # Vendor Package to Water Drain
        ...
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, 675, 300, 910, 300, 2)    # to NH3 CHEM VENT
        ...
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, 425, -300, 425, -260, 2)  # PI 10134 to CHEM VENT LINE
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, 625, -300, 625, -260, 2)  # PIC 10126 to CHEM VENT
        ...
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, -450, -500, 900, -500, 2) # HV115 L-119-PID-101 to CHEM VENT LINE
        SchematicHelperFunctions.DrawConnectionLine(self.systemControlScene, 900, -500, 900, -220, 2) # N2 CYLINDER to CHEM VENT LINE
